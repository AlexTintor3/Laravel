...
class DatabaseSeeder extends Seeder
{
	private $arrayPeliculas = array(
		...
		array(
			...
			'poster' => 'https://3.bp.blogspot.com/-sCV1jDZlJ4w/Uoc0bvWLfXI/AAAAAAAAHRc/3Hb07TM1P4U/s1600/el+golpe+cartel.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://www.cinetecamadrid.com/sites/default/files/2018-11/cartel_LAVIDA_ES_BELLA.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://www.ecartelera.com/carteles/6200/6236/001.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'http://3.bp.blogspot.com/-o00F2CmRBZE/VChFg17vs5I/AAAAAAAAJME/C95Vc4rGWl0/s1600/Blade%2BRunner%2B-%2BCartel%2BDirectors%2Bcut.jpg', 
			'rented' => true, 
    ...
    private function seedUsers() {
    	...
    	$user = new User;
    	$user->name = 'alex';
    	$user->email = 'alex@iesiliberis.com';
    	$user->password = bcrypt('alex');
    	$user->save();

    	$user = new User;
    	$user->name = 'ruberto';
    	$user->email = 'ruberto@iesiliberis.com';
    	$user->password = bcrypt('ruberto');
    	$user->save();
    }
